...
contains
  ...
  elemental subroutine operator_real64_destructor(self)
    implicit none
  ...
  elemental subroutine operator_real64_proxy_destructor(self)
    implicit none
    type(operator_real64_proxy_type), intent(inout) :: self
