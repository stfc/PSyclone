...
!-----------------------------------------------------------------------------
!
!> @brief A module providing scalar related classes for real32 data
!>
!> @details A representation of a real32 scalar which provides both
...
module scalar_real32_mod
  ...
  !>
  type, public :: scalar_real32_type
    private
...
contains
  ...
  subroutine initialise(self, value, mpi)
    implicit none
    class(scalar_real32_type),   intent(inout) :: self
  ...
  subroutine reduction_finish(self)
    implicit none
    class(scalar_real32_type), intent(in) :: self
    real(kind=real32) ::  value_tmp
