...
private:
  ...
  public:
    ...
    void run(storage_ijk_t& tmask_, storage_ijk_t& tsn_, storage_ijk_t& vmask_,
             storage_ij_t& upsmsk_, storage_ijk_t& pwn_, storage_ijk_t& pvn_,
             storage_k_t& rnfmsk_z_, storage_ijk_t& pun_, storage_ij_t& ztfreez_,
             storage_ijk_t& zslpx_, storage_ij_t& rnfmsk_, storage_ijk_t& mydomain_,
             storage_ijk_t& umask_, storage_ijk_t& zslpy_0_, storage_ijk_t& zslpx_1_) {
	...
	tsn_sum = 0.0;
		...
		tsn_sum += tsn(i,j,k);
                ...
                ::dawn::float_type __local_tmp__1227 = upsmsk(i + 0, j + 0, k + 0);
                ...
                zind(i + 0, j + 0, k + 0) = (__local_res__1225 * tmask(i + 0, j + 0, k + 0));
          ...
          for(int i = iMin + 0; i <= iMax + 0; ++i) {
            for(int j = jMin + 0; j <= jMax + 0; ++j) {
              if(checkOffset(stage2465GlobalIIndices[0], stage2465GlobalIIndices[1],
                ...
                ::dawn::float_type __local_tm_1224 = zslpy_0(i + 0, j + 0, k + 0);
                ...
                ::dawn::float_type __local_tm_1202 = zwy(i + 0, j + -1, k + 0);
                ...
                ::dawn::float_type __local_tm_1231 = zwy(i + 0, j + 0, k + 0);
                ...
                zslpy(i + 0, j + 0, k + 0) = (res_sign_1(i + 0, j + 0, k + 0) * __local_re_1215);
              }
            }
          }
        }
          ...
          for(int i = iMin + 0; i <= iMax + 0; ++i) {
            for(int j = jMin + 0; j <= jMax + 0; ++j) {
              if(checkOffset(stage2506GlobalIIndices[0], stage2506GlobalIIndices[1],
                ...
                ::dawn::float_type __local_z0u_1237 = res_sign(i + 0, j + 0, k + 0);
                zalpha(i + 0, j + 0, k + 0) = ((::dawn::float_type)0.5e0 - __local_z0u_1237);
                ::dawn::float_type __local_zu_1199 =
                    (__local_z0u_1237 - (((::dawn::float_type)0.5e0 * pun(i + 0, j + 0, k + 0)) *
                                         zdt(i + 0, j + 0, k + 0)));
                zzwx(i + 0, j + 0, k + 0) = (mydomain(i + 1, j + 0, k + 0) +
                                             (zind(i + 0, j + 0, k + 0) *
                                              (__local_zu_1199 * zslpx_0(i + 1, j + 0, k + 0))));
                zzwy(i + 0, j + 0, k + 0) = (mydomain(i + 0, j + 0, k + 0) +
                                             (zind(i + 0, j + 0, k + 0) *
                                              (__local_zu_1199 * zslpx_0(i + 0, j + 0, k + 0))));
                zwx(i + 0, j + 0, k + 0) =
                    (pun(i + 0, j + 0, k + 0) *
                ...
                ::dawn::float_type __local_z0v_1236 = res_sign_1(i + 0, j + 0, k + 0);
                zalpha(i + 0, j + 0, k + 0) = ((::dawn::float_type)0.5e0 - __local_z0v_1236);
                ::dawn::float_type __local_zv_1234 =
                    (__local_z0v_1236 - (((::dawn::float_type)0.5e0 * pvn(i + 0, j + 0, k + 0)) *
                                         zdt(i + 0, j + 0, k + 0)));
                zzwx(i + 0, j + 0, k + 0) =
                    (mydomain(i + 0, j + 1, k + 0) +
                     (zind(i + 0, j + 0, k + 0) * (__local_zv_1234 * zslpy(i + 0, j + 1, k + 0))));
                zzwy(i + 0, j + 0, k + 0) =
                    (mydomain(i + 0, j + 0, k + 0) +
                     (zind(i + 0, j + 0, k + 0) * (__local_zv_1234 * zslpy(i + 0, j + 0, k + 0))));
                zwy(i + 0, j + 0, k + 0) =
                    (pvn(i + 0, j + 0, k + 0) *
                     ((zalpha(i + 0, j + 0, k + 0) * zzwx(i + 0, j + 0, k + 0)) +
          ...
          for(int i = iMin + 0; i <= iMax + 0; ++i) {
            for(int j = jMin + 0; j <= jMax + 0; ++j) {
              if(checkOffset(stage2585GlobalIIndices[0], stage2585GlobalIIndices[1],
                ...
                ::dawn::float_type __local_z0w_1208 = res_sign(i + 0, j + 0, k + 0);
                zalpha(i + 0, j + 0, k + 0) = ((::dawn::float_type)0.5e0 + __local_z0w_1208);
                ::dawn::float_type __local_zw_1205 =
                    (__local_z0w_1208 - ((((::dawn::float_type)0.5e0 * pwn(i + 0, j + 0, k + 0)) *
                                          zdt(i + 0, j + 0, k + 0)) *
                                         zbtr(i + 0, j + 0, k + 0)));
                zzwx(i + 0, j + 0, k + 0) =
                    (mydomain(i + 0, j + 0, k + 0) +
                     (zind(i + 0, j + 0, k + -1) * (__local_zw_1205 * zslpx(i + 0, j + 0, k + 0))));
                zzwy(i + 0, j + 0, k + 0) = (mydomain(i + 0, j + 0, k + -1) +
                                             (zind(i + 0, j + 0, k + -1) *
                                              (__local_zw_1205 * zslpx(i + 0, j + 0, k + -1))));
                zwx(i + 0, j + 0, k + 0) =
                    (pwn(i + 0, j + 0, k + 0) *
                     ((zalpha(i + 0, j + 0, k + 0) * zzwx(i + 0, j + 0, k + 0)) +
                      (((::dawn::float_type)1. - zalpha(i + 0, j + 0, k + 0)) *
