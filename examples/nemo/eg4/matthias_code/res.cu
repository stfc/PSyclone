...
__global__ void __launch_bounds__(128) psyclone_stencil1238_ms4319_kernel(
    const int isize, const int jsize, const int ksize, const int stride_110_1,
    const int stride_111_1, const int stride_111_2, const int tmpBeginIIndex,
    ...
    ::dawn::float_type* const rnfmsk_z, ::dawn::float_type* const upsmsk,
  ...
  for(int k = 0 + 0; k <= ksize - 1 + 0 + 0; ++k) {
    ...
    if(iblock >= 0 && iblock <= block_size_i - 1 + 0 && jblock >= 0 &&
      ...
      ::dawn::float_type __local_tmp__1212 = __ldg(&(upsmsk[idx110]));
      ...
      zind_kcache[0] = (__local_res__1229 * __ldg(&(tmask[idx111])));
...
__global__ void __launch_bounds__(128) psyclone_stencil1238_ms4328_kernel(
    ...
    ::dawn::float_type* const zslpx_1, gridtools::data_view<TmpStorage> zslpy_dv,
    gridtools::data_view<TmpStorage> zwy_dv, gridtools::data_view<TmpStorage> zwx_dv) {
  ...
  for(int k = 0 + 0; k <= ksize - 1 + -1 + 0; ++k) {
    ...
    if(iblock >= 0 && iblock <= block_size_i - 1 + 0 && jblock >= 0 &&
      ...
      ::dawn::float_type __local_tm_1225 = __ldg(&(zslpy_0[idx111]));
      ...
      ::dawn::float_type __local_tm_1236 = __ldg(&(zwy[idx_tmp + jstride_tmp * -1]));
      ...
      ::dawn::float_type __local_tm_1222 = __ldg(&(zwy[idx_tmp]));
      ...
      zslpy_kcache[0] = (res_sign_1_kcache[0] * __local_re_1211);
    }
    // Flush of kcaches
    if(iblock >= 0 && iblock <= block_size_i - 1 + 0 && jblock >= 0 &&
       jblock <= block_size_j - 1 + 0) {
...
__global__ void __launch_bounds__(128) psyclone_stencil1238_ms4331_kernel(
    const int isize, const int jsize, const int ksize, const int stride_111_1,
    const int stride_111_2, const int tmpBeginIIndex, const int tmpBeginJIndex,
    const int jstride_tmp, const int kstride_tmp, ::dawn::float_type* const mydomain,
    ::dawn::float_type* const pvn, ::dawn::float_type* const pun,
    gridtools::data_view<TmpStorage> zslpy_dv, gridtools::data_view<TmpStorage> zwy_dv,
  ...
  for(int k = 0 + 0; k <= ksize - 1 + -1 + 0; ++k) {
    ...
    if(iblock >= 0 && iblock <= block_size_i - 1 + 0 && jblock >= 0 &&
      ...
      ::dawn::float_type __local_z0u_1219 = res_sign_kcache[0];
      zalpha_kcache[0] = ((::dawn::float_type)0.5e0 - __local_z0u_1219);
      ...
      zzwx_kcache[0] = (__ldg(&(mydomain[idx111 + 1 * 1])) +
                        (zind_kcache[0] * (__local_zu_1207 * __ldg(&(zslpx_0[idx_tmp + 1 * 1])))));
      zzwy_kcache[0] = (__ldg(&(mydomain[idx111])) +
                        (zind_kcache[0] * (__local_zu_1207 * __ldg(&(zslpx_0[idx_tmp])))));
      ...
      ::dawn::float_type __local_z0v_1201 = res_sign_1_kcache[0];
      zalpha_kcache[0] = ((::dawn::float_type)0.5e0 - __local_z0v_1201);
      ::dawn::float_type __local_zv_1231 =
          (__local_z0v_1201 -
           (((::dawn::float_type)0.5e0 * __ldg(&(pvn[idx111]))) * zdt_kcache[0]));
      zzwx_kcache[0] =
          (__ldg(&(mydomain[idx111 + stride_111_1 * 1])) +
           (zind_kcache[0] * (__local_zv_1231 * __ldg(&(zslpy[idx_tmp + jstride_tmp * 1])))));
      zzwy_kcache[0] = (__ldg(&(mydomain[idx111])) +
                        (zind_kcache[0] * (__local_zv_1231 * __ldg(&(zslpy[idx_tmp])))));
...
__global__ void __launch_bounds__(128) psyclone_stencil1238_ms4342_kernel(
    ...
    ::dawn::float_type* const mydomain, ::dawn::float_type* const zslpx,
    gridtools::data_view<TmpStorage> zwx_dv, gridtools::data_view<TmpStorage> zind_dv,
  ...
  for(int k = 1 + 0; k <= ksize - 1 + 0 + 0; ++k) {
    ...
    if(iblock >= 0 && iblock <= block_size_i - 1 + 0 && jblock >= 0 &&
      ...
      ::dawn::float_type __local_z0w_1234 = res_sign_kcache[0];
      zalpha_kcache[0] = ((::dawn::float_type)0.5e0 + __local_z0w_1234);
      ::dawn::float_type __local_zw_1232 =
          (__local_z0w_1234 -
           ((((::dawn::float_type)0.5e0 * __ldg(&(pwn[idx111]))) * zdt_kcache[0]) *
            zbtr_kcache[0]));
      zzwx_kcache[0] =
          (mydomain_kcache[1] + (zind_kcache[0] * (__local_zw_1232 * zslpx_kcache[1])));
      zzwy_kcache[0] =
          (mydomain_kcache[0] + (zind_kcache[0] * (__local_zw_1232 * zslpx_kcache[0])));
...
public:
  ...
  public:
    ...
    void run(storage_ij_t ztfreez_ds, storage_ijk_t pwn_ds, storage_ijk_t vmask_ds,
             storage_ij_t rnfmsk_ds, storage_ijk_t mydomain_ds, storage_ijk_t tmask_ds,
             storage_ijk_t umask_ds, storage_ijk_t tsn_ds, storage_ijk_t pvn_ds,
             storage_k_t rnfmsk_z_ds, storage_ijk_t pun_ds, storage_ij_t upsmsk_ds,
             storage_ijk_t zslpx_ds, storage_ijk_t zslpy_0_ds, storage_ijk_t zslpx_1_ds) {
      ...
      start();
      {
        ...
        psyclone_stencil1238_ms4319_kernel<<<blocks, threads>>>(
            nx, ny, nz, ztfreez_ds.strides()[1], tmask_ds.strides()[1], tmask_ds.strides()[2],
      ...
      };
      {
        ...
        psyclone_stencil1238_ms4331_kernel<<<blocks, threads>>>(
            ...
            zslpy, zwy, zwx, zind, zdt, zslpx_0);
      };
      {
        ;
        gridtools::data_view<storage_ijk_t> mydomain = gridtools::make_device_view(mydomain_ds);
...
public:
  ...
  void run(storage_ij_t ztfreez, storage_ijk_t pwn, storage_ijk_t vmask, storage_ij_t rnfmsk,
           ...
           storage_ijk_t zslpx) {
    sync_storages(ztfreez, pwn, vmask, rnfmsk, mydomain, tmask, umask, tsn, pvn, rnfmsk_z, pun,
                  upsmsk, zslpx);
