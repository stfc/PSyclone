module adj_split_w2_field_kernel_mod
  use argument_mod, only : any_space_1, arg_type, cell_column, gh_field, gh_inc, gh_readwrite, gh_real
  ...
  PRIVATE
  TYPE(arg_type) :: meta_args(3) = (/arg_type(GH_FIELD, GH_REAL, GH_INC, W2h), arg_type(GH_FIELD, GH_REAL, GH_READWRITE, W2v), &
