module adj_hydrostatic_kernel_mod
  use argument_mod, only : any_w2, arg_type, cell_column, func_type, gh_basis, &
       gh_diff_basis, gh_field, gh_inc, gh_quadrature_xyoz, gh_read, gh_real, gh_scalar, &
       gh_readwrite
  ...
  PRIVATE
  TYPE(arg_type) :: meta_args(8) = (/arg_type(GH_FIELD, GH_REAL, GH_READ, ANY_W2), &
...
&GH_REAL, GH_READ)/)
  TYPE(func_type) :: meta_funcs(3) = (/ &
       func_type(ANY_W2, GH_BASIS, GH_DIFF_BASIS), func_type(W3, GH_BASIS), func_type(Wtheta, &
