...
# not match the kernel interface.
# CALL adj_rhs_sample_eos_code(nlayers, field_1_proxy%data, field_2_proxy%data, field_3_proxy%data, field_4_proxy%data, &
# &field_5_proxy%data, field_6_proxy%data, field_7_proxy%data, field_8_proxy%data, field_9_proxy%data, rscalar_10, rscalar_11, &
# &rscalar_12, ndf_w3, undf_w3, map_w3(:,cell), basis_w3_on_w3, basis_w3_on_wtheta, ndf_wtheta, undf_wtheta, map_wtheta(:,cell), &
# &basis_wtheta_on_w3, basis_wtheta_on_wtheta)
...
#kernels_to_process=["hydrostatic_kernel"]
