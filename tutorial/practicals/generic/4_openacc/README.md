...
[OpenACC](https://psyclone.readthedocs.io/en/latest/user_guide/transformations.html#openacc)
Transformations page of the PSyclone User Guide.
...
4. How do we add the `COLLAPSE` clause? If we look at the documentation
   for [ACCLoopTrans](https://psyclone.readthedocs.io/en/latest/_autogenerated/autoapi/psyclone.transformations.html#psyclone.transformations.ACCLoopTrans)
   , we see that it takes an `options`
