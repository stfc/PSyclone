...
documented in our [user guide]
(https://psyclone.readthedocs.io/en/latest/dynamo0p3.html) (search for
`Dynamo0p3AsyncHaloExchangeTrans`). Alternatively, if you prefer, a
pdf of the user guide is also available in <psyclone_home> and is
called psyclone.pdf
