...
Running the PSyclone [kernel tool](https://psyclone.readthedocs.io/en/latest/psyclone_kern.html)
...
https://psyclone.readthedocs.io/en/latest/psyclone_kern.html) very useful
for development.
