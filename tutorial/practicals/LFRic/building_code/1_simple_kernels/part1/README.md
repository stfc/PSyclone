...
```shell
psyclone-kern --stub-gen setval_field_w0_kernel_mod.f90
```
...
```shell
psyclone-kern --stub-gen setval_field_w3_kernel_mod.f90
```
...
with the same argument order as generated by using `psyclone-kern --stub-gen`.
