...
# built documents.
#
# We use the version module generated by setup.py so that we are always
# consistent with the version specified in that file.
# 'version' is the short X.Y version and 'release' is the full version,
# including any alpha/beta/rc tags.
from psyclone.version import version as release, short_version as version
