...
# documentation.
html_theme_options = {
    # We have 6 top menu items, too fit them all at the top bar we set navbar
    # alignment left (start just after the logo), alternatively we could align
    # them with the content (theme default), but them not all of them fit and
    # some will have to go into a dropdown menu by reducing the first parameter
