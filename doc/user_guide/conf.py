...
if github_pr_num:
    ...
    # This is not a CI run so we link to the standard, latest version of
    # the documentation on the WWW.
    dev_guide_base = 'https://psyclone-dev.readthedocs.io/en/latest/'
    ref_guide_base = (
