...
if use_external_links == '1':
    apilinks_base = \
        'https://psyclone-ref.readthedocs.io/en/latest/autogenerated/'
else:
    # Otherwise we generate links to the locally-built versions of the
    # documentation. The last, empty string argument to join() is required
    # to get a trailing '/' character.
    apilinks_base = os.path.join(docs_dir, 'reference_guide', 'build', 'html',
                                 'autogenerated', '')
