...
project_copyright = ('2019-2025, R. W. Ford, J. Henrichs, I. Kavcic, '
                     'A. R. Porter, S. Siso')
...
autoapi_modules = {'psyclone': {'output': 'autogenerated'}}
...
def modify_dict_signature(app, what, name, obj, options, signature, return_annotation):
    '''
    '''
    #if name.endswith("Transformation"):
...
def setup(app):
    ...
    app.connect('autodoc-process-signature', modify_dict_signature)
