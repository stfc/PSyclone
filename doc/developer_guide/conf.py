...
if github_pr_num:
    ...
    psyad_usr_guide_base = 'http://0.0.0.0:8000/psyad/user_guide/_build/html/'
else:
    ...
    ref_guide_base = (f'https://psyclone-ref.readthedocs.io/en/{version_txt}'
                      f'/autogenerated/')
    psyad_usr_guide_base = (
        f'https://psyclone-adjoint.readthedocs.io/en/{version_txt}')
...
copyright = u'2017-2024, STFC Daresbury Laboratory'
...
# Allows us to link to the PSyclone and/or PSyAD User Guides. The base
