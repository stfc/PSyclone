module adj_transpose_matrix_vector_kernel_mod
  ...
  implicit none
  interface adj_transpose_matrix_vector_code
  module procedure adj_transpose_matrix_vector_code_r_single, adj_transpose_matrix_vector_code_r_double
end interface
...
END TYPE
  ...
  private :: adj_transpose_matrix_vector_code_r_single, adj_transpose_matrix_vector_code_r_double

  contains
  subroutine adj_transpose_matrix_vector_code_r_single(cell, nlayers, lhs, x, ncell_3d, matrix, ndf1, undf1, map1, ndf2, undf2, &
&map2)
  ...
  end subroutine adj_transpose_matrix_vector_code_r_single
  subroutine adj_transpose_matrix_vector_code_r_double(cell, nlayers, lhs, x, ncell_3d, matrix, ndf1, undf1, map1, ndf2, undf2, &
&map2)
    integer(kind=i_def), intent(in) :: cell
    integer(kind=i_def), intent(in) :: nlayers
    integer(kind=i_def), intent(in) :: ncell_3d
  ...
  end subroutine adj_transpose_matrix_vector_code_r_double
